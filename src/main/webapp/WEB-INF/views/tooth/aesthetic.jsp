        ...
        <section class="section05 section-quotes-title section-quotes-title-right wow fadeInUp">
            ...
            <div class="max-layout-width">
                <div class="text">
                    <div>
                        <h2 class="section-title">
                            <strong>적은양의 치아삭제</strong>로<br>
                            하루만에 가능한 라미네이트
                        </h2>
                        <p class="section-text">
                           자연치아를 많이 보존한 상태에서 치아의 건강함과 아름다움을 동시에 만족시키며 더욱 자신있고 매력적인 인상을 하루만에 만들어 드립니다. 가능한 매우 얇고 심미성이 뛰어난 재질로
        ...
        <section class="text-slider wow fadeInUp">
            ...
            <div class="slider wow fadeInUp" data-wow-delay="900ms">
                <div>
                    <div class="text">
                        <h2>
                            <strong>적은양을 삭제하여<br>치아라인을 예쁘게<br>살려냅니다.</strong>
                        </h2>
                        <h3>01</h3>
                        <p>
                    ...
                    <div class="text mobile-text">
                        <h2>
                            <strong>미소원치과는<br> 적은 양의 삭제로 안전하고<br> 예쁘게 살려냅니다.</strong>
                        </h2>
                        <h3>01</h3>
                        <p>
                            미소원치과에서는 치아삭제를 많이하면 치아의 근관이 훼손되어 시림 증상이나 통증이 일어나는 부작용을 방지하기위해 시술경험이 풍부한 의료진들이 치아 앞면을 미세하게 삭제하여 치아건강을
                ...
                <div>
                    <div class="text">
                        ...
                        <h3>04</h3>
                        <p>
                            자연스러움과 함께 건강한 치료를 위해 치아 삭제는 줄이면서 만족스러운 결과를 얻을 수 있도록 자연치아의 특성을 지속적으로 연구하고 있습니다.
                        </p>
                    </div>
                    <div class="img img04">
                        ...
                        <div class="slide" data-index="02">
                            <div class="swiper-slide">
                                ...
                                <div class="text">
                                    <h2>적은양의 치아 삭제</h2>
                                    <p>
                                        적은양의 치아만 삭제해 라미네이트를 부착할 준비를 진행합니다.
                                    </p>
                                </div>
                            </div>
                        </div>
