...
<div class="sub-contents grow">
    ...
    <div class="tab-container tab-contents2 active">
        ...
        <section class="text-slider wow fadeInUp">
            ...
            <div class="slider wow fadeInUp" data-wow-delay="900ms">
                <div>
                    <div class="text">
                        <h2>
                            <strong>미소원치과는 적은 양의 삭제로<br>안전하고 예쁘게<br>치아를 살려냅니다.</strong>
                        </h2>
                        <h3>01</h3>
                        <p>
                ...
                <div>
                    ...
                    <div class="text mobile-text">
                        ...
                        <h3>02</h3>
                        <p>
                            부작용의 우려가 없도록 시술 전에 충치 치료, 신경치료등 필요한 치료를 진행하고, 적은 양의
                            치아를 삭제하여 시린 증상 등 부작용을 줄이도록 안전하게 치료를 진행하고 있습니다.
            ...
            <div class="max-layout-width">
                ...
                <div class="table-container wow fadeInUp" data-wow-delay="600ms">
                    <table class="table">
                        <thead>
                        <tr>
                            <th class="table-left">라미네이트</th>
                            <th class="table-middle">VS</th>
                            <th class="table-right">올세라믹 크라운</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td class="table-left"><div class="img01">
                                <img src="<c:url value='/images/sub/tooth/aesthetic/aesthetic06_1.jpg'/>">
                            </div></td>
                            <td class="table-middle">시술 방법</td>
                            <td class="table-right"><div class="img02">
                                <img src="<c:url value='/images/sub/tooth/aesthetic/aesthetic06_2.jpg'/>">
                            </div></td>
                        </tr>
                        <tr>
                            <td class="table-left">
                            ...
                            <td class="table-middle">치아 삭제</td>
                        ...
                        <div class="slide" data-index="02">
                            <div class="swiper-slide">
                                ...
                                <div class="text">
                                    <h2>적은양의 치아 삭제</h2>
                                    <p>
                                        올세라믹 보철물을 부착하기 위해 적은양의 치아를 삭제합니다.
                                    </p>
                                </div>
                            </div>
                        </div>
