...
<div class="sub-contents grow">
    <h1 class="sub-page-title">충치/치주/신경치료</h1>
    <p class="sub-page-intro">TOOTH DECAY / PERIODONTAL / NEUROTHERAPY</p>
        ...
        <div class="max-layout-width text">
            <div>
                <h2 class="section-title">
                    <span class="section-title-color"><strong>소중한 자연치아의 가치</strong></span>를<br>
                    한번 더 생각합니다.
                </h2>
            </div>
        </div>
            ...
            <div class="max-layout-width">
                <div>
                    <p class="section-text">
                        충치 및 신경치료 때문에 내원하시는 환자분들의 경우 심한 치통으로 인하여 내원하시는 분들이 많습니다. 환자분들의 고통을 이해하여,
                        <strong>최대한 빠르고 완벽하게 해결할 수 있도록 노력</strong>하겠습니다.
                    </p>
                    <p class="section-text">
                        미소원치과는 신뢰하고 찾아주시는 분들을 위해 <strong>자연치아 살리기에 힘써 환자 분들의 치아를 가능한 오래 살려서 쓸 수 있도록</strong> 
                        언제나 최선을 다하고 노력을 멈추지 않을 것을 약속 드립니다.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="tab-container tab-container1 active wow fadeInUp">
        ...
        <section class="section05 wow fadeInUp">
            <div class="max-layout-width">
                ...
                <div class="img-contents img-contents2">
                    ...
                    <div class="text">
                        <div>
                            ...
                            <p>
                                인레이는 충치 부위가 넓거나 깊지만, 신경치료는 요하지 않는 경우 사용되는 치료방법으로
                                <strong>넓은 우식 부위 회복이 가능</strong>하며,
                                심미적으로도 우수하고 <strong>강도도 높은 수복치료</strong>입니다.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="img-contents img-contents3">
                    ...
                    <div class="text">
                        <div>
                            <h2>충치 치료의 종류 03) 크라운</h2>
                            <p>
                                크라운은 치아 전체를 씌워주는 치료로<br>
                                충치 부위가 광법위하게 넓은 경우 인레이 치료보다 보철물이 탈착될 위험이 적고,
                                신경 조직까지 손상된 경우, <strong>신경치료 마무리 후 진행되는 수복치료</strong>입니다.
                            </p>
                        </div>
                    </div>
                </div>
