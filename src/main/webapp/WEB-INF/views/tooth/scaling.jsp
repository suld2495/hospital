...
<div class="sub-contents grow">
    <h1 class="sub-page-title">스케일링</h1>
    <p class="sub-page-intro">SCALING</p>
            ...
            <div class="max-layout-width">
                <div>
                    <p class="section-text">
                        스케일링은 구강을 청결하게 유지하며 치주 질환을 예방하는데 도움이 됩니다. 치아 표면에 부착된 치태,치석,세균막,색소 등을 제거하고 치아 표면을
                        매끄럽게 하여 이들의 재부착을 방지합니다.
                    </p>
                    <p class="section-text">
                        치석은 잇몸질환,충치를 유발하는 원인으로 제거해야 합니다.<br>
                        정기적인 스케일링은 치주 질환의 원인을 제거하고,치아 표면을 깨끗하게 만들어야 합니다.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="text">
                <div>
                    ...
                    <p class="section-text">
                        ...
                        통증 없이 개운하게 말끔히 없애드립니다. 건강한 치아와 잇몸을 위해 치아 스케일링은 개인 차가 있지만 보통은 6개월~1년마다 받으시는 것이 바람직합니다.
                    </p>
                </div>
            </div>
        </div>
