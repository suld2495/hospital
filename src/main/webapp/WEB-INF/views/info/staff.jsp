...
<link rel="stylesheet" href="<c:url value="/css/info/staff.css"/>" />

<div class="sub-contents">
    <h1 class="sub-page-title">의료진 소개</h1>
    <p class="sub-page-intro">DENTAL STAFF INTRODUCTION</p>

    <div class="max-layout-width">
        <ul class="tab display-inline-block">
            <li data-tab="doctor" class="doctor-tab active pointer">의료진</li>
            <li data-tab="staff" class="staff-tab pointer">진료팀 소개</li>
        </ul>
    </div>
            ...
            <div class="doctor-info position-relative">
                ...
                <div class="text text-bg">
                    <div class="text-dec wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <h4 class="dec-title bold">약력내역</h4>
                        <p class="dec">
                            치의학 박사<br/>
                            통합치의학과 전문의<br/>
                            부산대학교 치과대학 졸업<br/>
                ...
                <div class="text text-bg">
                    <div class="text-dec max-layout-width position-relative wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <p class="dec">
                            ...
                            <br/>
                            돌출입교정, 주걱턱교정, 덧니교정, 수술교정
                        </p>
                        <h4 class="dec-title bold">약력내역</h4>
                        <p class="dec">
                            한국 과학기술원(KAIST)생명화학공학과 석사 졸업<br/>
                            부산대학교 치의학전문대학원 졸업 및 치무석사<br/>
                            경북대학교 치과대학 치의학 박사<br/>
                            전) 부산 금정 이루미교정치과 교정원장<br/>
                            전) 경남 김해 장유 배치과의원 교정원장<br/>
                            전) 경남 양산 바룸치과 교정원장<br/>
                            전) 영산대학교 치위생과 외래교수<br/>
                            대한 치과보철학회 정회원<br/>
                            대한 구강악안면임플란트학회 정회원<br/>
                            Tweed-Merrifield 교정코스<br/>
                            한국치과 교정연구회 정회원<br/>
                            인비절라인 인증의<br/>
                        </p>
                    </div>
                ...
                <div class="text">
                    <div>
                        ...
                        <p clas="wow fadeInUp" data-wow-delay="900ms">
                            ...
                            진료가 원활하게 이루어지도록 도와드리며 치아 상태는 어떠신지,
                            불편한 곳은 없으신지 확인합니다.
                        </p>
                    </div>
                </div>
                ...
                <div class="text text-left">
                    <div>
                        ...
                        <p class="wow fadeInUp" data-wow-delay="900ms">
                            ...
                            환자분들께 최선을 다하고 있습니다. 환자분이 최적의 구강건강을
                            유지하도록 도와드리고 있습니다.
                        </p>
                    </div>
                </div>
                ...
                <div class="text">
                    <div>
                        ...
                        <p class="wow fadeInUp" data-wow-delay="900ms">
                            ...
                            치기공사의 소통이 매우 중요합니다. 보철치료 의료진과 즉각적인
                            소통을 통해 보다 섬세하고 신속한 맞춤 제작이 가능합니다.
                        </p>
                    </div>
                </div>
            </div>
