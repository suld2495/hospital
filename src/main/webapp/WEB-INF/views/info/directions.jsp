...
<div class="sub-contents">
    ...
    <section class="section04">
        <div class="max-layout-width">
            <ul>
                <li class="car">
                    <h2>자가용으로 내원하시는 방법</h2>
                    <p>
                        네비게이션 실행후 <strong>미소원치과 검색</strong> 또는 <strong>울산광역시 남구 화합로 150'으로 검색</strong>하신 후 미소원치과로 오시면 됩니다.<br>
                ...
                <li class="bus">
                    <h2>버스로 내원하시는 방법</h2>
                    <p>
                        <strong>246,407,507,702,713,714,715,722,724,732,744,920,2100</strong> 고속버스터미널 앞 하차하셔서 <strong>파리바게뜨 방향으로 횡단보도를 건너 미소원치과로</strong> 오시면 됩니다.
                ...
                <li class="taxi">
                    <h2>택시로 내원하시는 방법</h2>
                    <p>
                        (구) 아웃백건물 옆 미소원치과 앞에서 하차하시면 됩니다.<br>
