...
<div class="sub-contents">
        ...
        <div class="max-layout-width">
            <div class="display-inline-block">
                ...
                <div class="location float-left">
                    <p class="wow fadeInUp" data-wow-delay="500ms">울산 남구 화합로 150 <span class="location-color">(2F 교정,임플란트,심미보철,일반진료 / 3F 임플란트,심미보철,일반진료)</span></p>
                    <h2 class="wow fadeInUp" data-wow-delay="800ms">T.1899-7518</h2>
                    <p class="info wow fadeInUp" data-wow-delay="800ms">
                        예약환자를 우선 진료하고 있으니, 필히 약속하시고 내원해주세요.
                    </p>
                    <p class="time wow fadeInUp" data-wow-delay="800ms">
    ...
    <section class="section03 scrolled-image wow fadeInUp" data-wow-delay="500ms">
        <div class="bg">
            <h2>약도 및 주차장 안내</h2>
    ...
    <section class="section04">
        <div class="max-layout-width">
            <h2 class="title wow fadeInUp" data-wow-delay="500ms"><strong>내원</strong>하시는 <strong>방법</strong></h2>
            <ul>
                <li class="car wow fadeInUp" data-wow-delay="300ms">
                    <h2>자가용</h2>
                    <p>
                ...
                <li class="bus wow fadeInUp" data-wow-delay="700ms">
                    <h2>버스</h2>
                    <p>
                ...
                <li class="taxi wow fadeInUp" data-wow-delay="1000ms">
                    <h2>택시</h2>
                    <p>
