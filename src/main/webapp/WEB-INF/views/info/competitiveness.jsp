...
<div class="sub-contents">
    <h1 class="sub-page-title">핵심경쟁력</h1>
        ...
        <div class="max-layout-width">
            <div class="list wow fadeInUp" data-wow-delay="500ms">
                <ul>
                    ...
                    <li>
                        <div class="list-img list-img2"></div>
                        <p>3차원 CT를 통해</p>
                        <p>정밀진단 후 사랑니 발치</p>
                    </li>
                    <li>
                        <div class="list-img list-img3"></div>
                        <p>교정치료 전문</p>
                        <p>건물 내 상주 협력 기공소</p>
                    </li>
                    <li>
                        <div class="list-img list-img4"></div>
                        <p>자연치아와 같은 편안하고</p>
                        <p>자연스러운 임플란트 치료</p>
                    </li>
                </ul>
            ...
            <div class="text">
                ...
                <div class="display-inline-block full-layout-width wow fadeInUp" data-wow-delay="900ms">
                    ...
                    <div class="img-box">
                        ...
                        <span class="bold">진료받는 공간 전체 멸균 처리</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function () {
        ...
        setInterval(function() {
            var index = ($('.tab.active').index() + 1) % 3;
            changeTab(index);
        }, time);
