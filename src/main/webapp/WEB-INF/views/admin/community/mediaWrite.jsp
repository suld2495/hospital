    ...
    <div class="content_wrap">
        <div class="qna_board_wrap">
            <article class="basicText">
                ...
                <div class="headerTextDiv2">미소원치과의 다양한 모습을 미디어를 통해 보실 수 있습니다.</div>
            </article>
                ...
                <form:form method="post" class="submit" action="${pageContext.servletContext.contextPath}/admin/boardUpdate/${url}" enctype="multipart/form-data" commandName="boardVo" accept-charset="utf-8">
                    ...
                    <div class="typeDiv">
                        ...
                        <div class="writerInputDiv input">
                            <select name="type">
                                <option <c:if test="${board.type eq '언론속의 미소원'}">selected</c:if>>언론속의 미소원</option>
                                <option <c:if test="${board.type eq '미소원 이야기'}">selected</c:if>>미소원 이야기</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="bnController">
                        <div class="writeLeft">
                            <div class="listFn bn"><a href="<c:url value='/admin/media/1'/>"><img src="<c:url value='/images/admin/writeList.jpg'/>"></a></div>
                        </div>
