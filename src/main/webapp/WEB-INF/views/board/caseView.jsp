...
<div class="sub-contents notice-view">
    ...
    <section class="board-view">
        <div class="max-layout-width">
            <div class="title">
                <p class="subject">미소원치과 네비게이션 임플란트 치료사례입니다.</p>
                ...
                <ul>
                    <li class="next">
                        <a href="<c:url value='/'/>">
                            ...
                            <span class="con">미소원치과 원데이 임플란트 치료사례입니다.</span>
                        </a>
                    </li>
                    <li class="prev">
                        <a href="<c:url value='/'/>">
                            <span><i class="prev-icon"></i>이전글</span>
                            <span class="con">미소원치과 전체 임플란트 치료사례입니다.</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="list">
                <a href="<c:url value='/case'/>">목록</a>
            </div>
        </div>
    </section>
</div>