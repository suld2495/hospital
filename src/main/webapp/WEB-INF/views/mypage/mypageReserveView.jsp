...
<c:set value="mypage-reserve-view" var="url" />

<div class="sub-contents notice-view">
    <h1 class="sub-page-title">예약내역</h1>
    <p class="sub-page-intro">RESERVATION</p>
    ...
    <section class="board-view">
        <div class="max-layout-width">
            ...
            <div class="list">
                <a href="<c:url value='/mypage_reservation/1'/>">목록</a>
            </div>
        </div>
    </section>
</div>
