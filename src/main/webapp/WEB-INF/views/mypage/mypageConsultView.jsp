...
<c:set value="mypage-consult-view" var="url" />

<div class="sub-contents notice-view">
    <h1 class="sub-page-title">온라인상담</h1>
    <p class="sub-page-intro">ONLINE CONSULT</p>
    ...
    <section class="board-view">
        <div class="max-layout-width">
            ...
            <div class="list">
                <a href="<c:url value='/mypage_consult/1'/>">목록</a>
            </div>
        </div>
    </section>
</div>
