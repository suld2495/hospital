            ...
            <div class="max-layout-width">
                <div>
                    <p class="section-text">
                        저희 미소원치과에서는 <strong>디지털 검사장비를 이용하여 환자분의 치아상태/턱관절/골격적인 특성을 꼼꼼하게 분석 후</strong>
                        분석결과를 직접 환자분께 보여드리며 효과적인 교정방법을 찾아드립니다.
                    </p>
                    <p class="section-text">
                        원장님과의 <strong>체계적이고 구체적인 1:1 상담을 통해 환자분이 가지고 계신 고민과 실제적으로 가지고 있는 문제를 모두 고려</strong>하여,
                        효과적이고 적합한 치료계획을 수립하여 제시합니다.
                    </p>
                </div>
            </div>
        </div>
