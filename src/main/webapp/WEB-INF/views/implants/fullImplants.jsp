            ...
            <div class="max-layout-width">
                <div>
                    <p class="section-text">
                        전체 임플란트는 본인 치아가 하나도 남지 않은 상태를 회복시켜주는 시술입니다. 한 악에 8~10개의 임플란트를 동시에 심는
                        난이도가 높은 시술이기에 숙련된 의료진의 충분한 임상경험이 뒷받침 되어야 교합에 대한 정확한 이해와 섬세한 기술력이 필요합니다.
                    </p>
                    <p class="section-text">
                        임플란트 치료를 하면 식사 시 움직임이 없으며, 씹히는 효율도 자연치아와 유사하게 발휘됩니다. 또한 틀니를 뺏다 꼈다 하는 불편함에서
                        해방될 수 있습니다.
                    </p>
                </div>
            </div>
