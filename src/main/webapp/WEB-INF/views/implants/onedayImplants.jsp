...
<div class="sub-contents onedayImplants">
            ...
            <div class="text">
                <div>
                    ...
                    <p class="section-text wow fadeInUp" data-wow-delay="900ms">
                        ...
                        수년간 다양하고 풍부한 임플란트 케이스 치료를 통해 깊이 있는 임플란트 치료를 완성하는 미소원치과의 의료진들과 함께하세요
                    </p>
                </div>
            </div>
        </div>
    ...
    <!--section class="section08">
        <div class="max-layout-width">
            ...
            <p class="section-text">
                원데이 임플란트는 환자의 건강 상태와 나이,잇몸뼈의 충분한 양이 있는 경우에만 가능한 시술 방법으로,
                주로 힘을 많이 받지 않는 앞니 등에 한정적으로 시술이 가능합니다. 발치 후 오랜 시간이 지나 잇몸뼈가 지나치가 흡수된 경우,
