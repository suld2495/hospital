            ...
            <div class="max-layout-width">
                <div>
                    <p class="section-text">
                        미소원치과는 본뜨는 불편함이 없는 3D 구강 스캐너, 정확한 진단에서 안전한
                        치료까지 3차원 CT정밀진단, 내 잇몸에 맞춘 세상에 하나뿐인 맞춤형 지대주까지
                        이 <strong>모두가 가능한 디지털 임플란트 시스템을 갖추었습니다.</strong>
                    </p>
                    <p class="section-text">
                        오랜 임상경험과 노하우를 바탕으로 이처럼 다양한 첨단 장비를 통해 보다
                        <strong>정확하고 정교한 임플란트 치료를 진행</strong>하고 있습니다.
            ...
            <div class="text">
                <div>
                    ...
                    <p class="section-text">
                        ...
                        특히, 성공적인 임플란트 치료를 위해서는 반드시 의료진의 경험이 풍부하고 수술사례가 많아햐합니다.
                    </p>
                </div>
            </div>
        </div>
